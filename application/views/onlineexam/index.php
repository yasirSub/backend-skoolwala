...
<?php endif; ?>
		...
		<div class="tab-content">
			<div class="tab-pane box active mb-md" id="list">
				<div class="export_title"><?php echo translate('online_exam') ." ". translate('list');?></div>
				<table class="table table-bordered table-hover mb-none table-condensed exam-list" cellpadding="0" cellspacing="0" width="100%">
					<thead>
						<tr>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		// initiate Datatable
		cusDataTable = initDatatable('.exam-list', 'onlineexam/getExamListDT');
