			...
			<div class="tabs-custom">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="admission">
						<?php echo form_open('frontend/section/saveAdmission' . $branchID, array('class' => 'form-horizontal frm-submit-data')); ?>
							...
							<div class="form-group">
								<label class="col-md-3 control-label"> <?php echo translate('terms_conditions') . " " .  translate('title'); ?></label>
								<div class="col-md-8"> 
							...
							<div class="form-group">
								<label class="col-md-3 control-label"><?php echo translate('terms_conditions') . " " . translate('description'); ?></label>
								<div class="col-md-8">
							...
							<div class="form-group">
								<label class="col-md-3 control-label"><?php echo translate('admission_application_form'); ?> <span class="required">*</span></label>
								<div class="col-md-4">
									<input type="hidden" name="old_admission_application_form" value="<?php echo $admission['application_form_file']; ?>">
									<input type="file" name="admission_application_form" class="dropify" data-height="100" data-default-file="" />
