						...
						<tbody>
							...
							<tr>
								...
								<?php if (get_permission('offline_payments', 'is_view')) { ?>
									<button type="button" class="btn btn-circle icon btn-default" data-loading-text="<i class='fas fa-spinner fa-spin'></i>" onclick="getApprovelOfflinePayments('<?=$row->id?>', this)">
...
<script type="text/javascript">
	...
	function getApprovelOfflinePayments(id, elem) {
		var btn = $(elem);
	    $.ajax({
